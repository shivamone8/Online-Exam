...
public final class studentlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </header>\n");
      out.write("    <center>\n");
      out.write("        <div style=\"width: 1200px;height: 600px;overflow: scroll;border: 2px solid black;background-color: lightgrey;\">\n");
      out.write("            <h2>Student List</h2>\n");
      out.write("            <table width=\"1100\" border=\"1\" cellspacing=\"0\" cellpadding=\"10\">\n");
      out.write("                <tr bgcolor=\"cyan\"><th>E Mail</th><th>Student Name</th><th>Qualification</th><th>DOB</th><th>Gender</th><th>Address</th><th>City</th>\n");
      out.write("                <th>State</th><th>Pin</th><th>Contact</th></tr>\n");
      out.write("                ");
                    ...
                    while(db.rst.next()){
                        out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td><td>"+db.rst.getString(4)+"</td><td>"
                                +db.rst.getString(5)+"</td><td>"+db.rst.getString(6)+"</td><td>"+db.rst.getString(7)+"</td><td>"+db.rst.getString(8)+
                                "</td><td>"+db.rst.getString(9)+"</td><td>"+db.rst.getString(10)+"</td></tr>");
                    }
